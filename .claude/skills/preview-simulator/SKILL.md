...
description: Build the current iOS code, install it on a simulator, configure the server URL, and launch the app. Use when the user wants to preview changes on the iOS simulator.
user-invocable: true
...
- **"No iPhone simulator found"** — open Xcode → Window → Devices and Simulators to create one
